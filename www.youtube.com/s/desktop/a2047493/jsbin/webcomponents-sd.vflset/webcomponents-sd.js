(function() {
    ...
    */
    ...
    v.Jb = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
    var ha = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
    v.j = !!(ha && ha.configurable && ha.get);
    v.inUse = v.force || !v.Jb;
    v.noPatch = v.noPatch || !1;
    v.O = v.preferPerformance;
    v.ma = "on-demand" === v.noPatch;
    ...
    function C() {
        var a = q.apply(0, arguments);
        if (1 === a.length) return ya(a[0]);
        var b = document.createDocumentFragment();
        a = ba(a);
        for (var c = a.next(); !c.done; c = a.next()) b.appendChild(ya(c.value));
        return b
    };
    var za = [],
        Aa;
    ...
    function Ga(a) {
        var b = a && a.ob;
        b && (b.Z.delete(a.Sa), b.Z.size || (r(a.nb).N = null))
    }
            ...
            a: {
                ...
                switch (h.nodeType) {
                    case Node.ELEMENT_NODE:
                        m = h.localName;
                        for (var n = "<" + m, t = h.attributes, A = 0, ea; ea = t[A]; A++) n += " " + ea.name + '="' + ea.value.replace(Ia, Ka) + '"';
                        n += ">";
                        h = Ma[m] ? n : n + Oa(h, l) + "</" + m + ">";
                        break a;
                    case Node.TEXT_NODE:
    ...
    function Ya() {
        ...
        window.EventTarget ? (D(window.EventTarget.prototype, a), void 0 === window.__shady_native_addEventListener && D(Window.prototype, a)) : (D(Node.prototype, a), D(Window.prototype, a));
        Pa ? D(Node.prototype, "parentNode firstChild lastChild previousSibling nextSibling childNodes parentElement textContent".split(" ")) : Ta(Node.prototype, {
            parentNode: {
                get: function() {
                    E.currentNode = this;
                    return E.parentNode()
        ...
        D(HTMLElement.prototype, ["parentElement", "contains"]);
        a = {
            firstElementChild: {
                get: function() {
                    F.currentNode = this;
        ...
        Pa ? (D(Element.prototype, Wa), D(Element.prototype, ["previousElementSibling", "nextElementSibling",
            "innerHTML", "className"
        ]), D(HTMLElement.prototype, ["children", "innerHTML", "className"])) : (Ta(Element.prototype, a), Ta(Element.prototype, {
        ...
        D(HTMLElement.prototype, ["focus", "blur"]);
        window.HTMLTemplateElement &&
            D(window.HTMLTemplateElement.prototype, ["innerHTML"]);
        Pa ? D(DocumentFragment.prototype, Wa) : Ta(DocumentFragment.prototype, a);
        D(DocumentFragment.prototype, Xa);
        Pa ? (D(Document.prototype, Wa), D(Document.prototype, ["activeElement"])) : Ta(Document.prototype, a);
        D(Document.prototype, ["importNode", "getElementById", "elementFromPoint", ja()]);
        D(Document.prototype, Xa)
    };
    var Za = B({
            get childNodes() {
    ...
    var cb = v.j || !0 === v.noPatch,
        ...
        eb = cb ? function() {} : function(a) {
            var b = r(a);
            b.Na || (b.Na = !0, wa(a, Za), window.customElements && window.customElements.polyfillWrapFlushCallback && !v.noPatch || wa(a, $a))
        };
    ...
    function ob(a, b) {
        ...
        for (var c = 0, d, e = void 0, f, g = void 0; c < b.length; c++)
            if (d = b[c], f = lb(d), f !== e && (g = a.indexOf(f), e = f), !x(f) || -1 < g) return d
    }
    var pb = {
            get composed() {
        ...
        qb = v.j && Object.getOwnPropertyDescriptor(Event.prototype, "eventPhase");
    ...
    function xb(a) {
        Ca();
        return !v.O && this instanceof Node && !qa(document, this) ? (a.__target || yb(a, this), vb(a)) : this.__shady_native_dispatchEvent(a)
    }
            ...
            if ("function" === m || "object" === m)
                if ("object" !== m || b.handleEvent && "function" === typeof b.handleEvent) {
                    ...
                    h = function(n) {
                        ...
                        if (!x(l) && "slot" !== l.localName || -1 != n.composedPath().indexOf(l))
                            ...
                            var ea = "function" === m ? b.call(l, n) : b.handleEvent && b.handleEvent(n);
    ...
    var dc = B({
        ...
        insertBefore: function(a, b) {
            ...
            ac(this, a);
            var d = [],
                e = (c = H(this)) ? c.host.localName : Sb(this),
                f = a.__shady_parentNode;
            if (f) {
                var g = Sb(a);
                var h = !!c || !H(a) || Vb && void 0 !== this.__noInsertionPoint;
            ...
            if (l || m) m && (g = g || Sb(a)), Tb(a, function(n) {
                ...
                if (m) {
                    var t = g;
                    G() && (t && Qb(n, t), (t = G()) && t.scopeNode(n, e))
                }
            });
            d.length && (c.pa(d), c.s());
            w(this) && (bc(a, this, b), h = u(this), h.root ? (f = !1, ka(this) && h.root.s()) : c && "slot" === this.localName && (f = !1, c.s()));
            f ? (c = x(this) ? this.host : this, b ? (b = $b(b), c.__shady_native_insertBefore(a, b)) : c.__shady_native_appendChild(a)) : a.ownerDocument !==
        ...
        removeChild: function(a, b) {
            ...
            var c = H(a),
                d = c && c.rb(a),
                e = u(this);
            if (w(this) && (cc(a, this), ka(this))) {
                e.root.s();
                var f = !0
            }
            if (G() && !b && c && a.nodeType !== Node.TEXT_NODE) {
                var g =
                    Sb(a);
                Tb(a, function(h) {
                    Qb(h, g)
        ...
        getRootNode: function(a) {
            if (this && this.nodeType) {
                var b = r(this),
                    c = b.ba;
                void 0 === c && (x(this) ? (c = this, b.ba = c) : (c = (c = this.__shady_parentNode) ? c.__shady_getRootNode(a) : this, document.documentElement.__shady_native_contains(this) && (b.ba = c)));
                return c
            }
        },
        contains: function(a) {
    ...
    var hc = {
            ...
            get children() {
                return w(this) ? sa(Array.prototype.filter.call(ua(this), function(a) {
                    return a.nodeType ===
                        Node.ELEMENT_NODE
        ...
        I = B((hc.append = function() {
            this.__shady_insertBefore(C.apply(null, p(q.apply(0, arguments))), null)
        }, hc.prepend = function() {
            this.__shady_insertBefore(C.apply(null, p(q.apply(0, arguments))), this.__shady_firstChild)
        }, hc.replaceChildren = function() {
            for (var a = q.apply(0, arguments), b; null !== (b = this.__shady_firstChild);) this.__shady_removeChild(b);
            this.__shady_insertBefore(C.apply(null, p(a)),
                null)
        }, hc)),
        ic = B({
            querySelector: function(a) {
    ...
    */
    var kc = B({
        after: function() {
            ...
            if (null !== a) {
                ...
                a.__shady_insertBefore(C.apply(null, p(q.apply(0, arguments))), b)
            }
        },
        before: function() {
            var a = this.__shady_parentNode;
            null !== a && a.__shady_insertBefore(C.apply(null, p(q.apply(0, arguments))), this)
        },
        remove: function() {
            var a = this.__shady_parentNode;
        ...
        replaceWith: function() {
            ...
            if (null !== b) {
                ...
                b.__shady_insertBefore(C.apply(null, p(a)), c)
            }
        }
    });
    ...
    function mc(a, b) {
        "slot" === b ? (a = a.__shady_parentNode, ka(a) && u(a).root.s()) : "slot" === a.localName && "name" === b && (b = H(a)) && (b.Eb(a), b.s())
    }
    var nc = B({
        get previousElementSibling() {
            var a = u(this);
    ...
    var rc = B({
        attachShadow: function(a) {
            ...
            if (a.shadyUpgradeFragment && !v.La) {
    ...
    var sc = document.implementation.createHTMLDocument("inert"),
        tc = B({
            get innerHTML() {
                return w(this) ? Oa("template" === this.localName ? this.content : this, ua) : this.__shady_native_innerHTML
            },
            set innerHTML(a) {
                if ("template" === this.localName) this.__shady_native_innerHTML = a;
                    ...
                    for (v.j ? b.__shady_native_innerHTML = a : b.innerHTML = a; a = b.__shady_firstChild;) this.__shady_insertBefore(a)
                }
            }
        });
    var uc = B({
    ...
    var vc = B({
        assignedNodes: function(a) {
            if ("slot" === this.localName) {
                ...
                b && x(b) && b.U();
                return (b = u(this)) ? (a && a.flatten ? b.K : b.assignedNodes) || [] : []
            }
        },
    ...
    var J = {};
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "parentElement") && (J.parentElement = dc.parentElement);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "contains") && (J.contains = dc.contains);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "children") && (J.children = I.children);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML") && (J.innerHTML = tc.innerHTML);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "className") && (J.className = nc.className);
    var K = {
            EventTarget: [Nb],
            ...
            Element: [nc, I, kc, ec, !v.j || "innerHTML" in Element.prototype ? tc : null, window.HTMLSlotElement ? null : vc],
            HTMLElement: [uc, J],
            HTMLSlotElement: [vc],
        ...
        Ec = v.j ? null : ["innerHTML", "textContent"];
    ...
    function Fc(a) {
        var b = a ? null : Ec,
            c;
        for (c in K) L(window[c] && window[c].prototype, K[c], a, b)
    ...
    function Mc(a, b) {
        ...
        z(a, tc, b);
        z(a, I, b);
        v.noPatch && !b ? (z(a, dc, b), z(a, wc, b)) : v.j || (z(a, ab), z(a, Za), z(a, $a))
    };
    var qc = {},
        M = v.deferConnectionCallbacks && "loading" === document.readyState,
        Nc;
    ...
    k._renderSelf = function() {
        ...
        if (!v.preferPerformance && !this.ua)
    ...
    k.Wa = function() {
        ...
        for (a = 0; a < this.g.length; a++) {
            ...
            (d = (d = u(b.__shady_parentNode)) && d.root) && (d.ta() || d.I) && d._renderSelf();
            this.oa(c.K, c.assignedNodes);
            if (d = c.za) {
                for (var e = 0; e < d.length; e++) u(d[e]).ga = null;
                c.za = null;
    ...
    k.ra = function(a, b) {
        ...
        b ? (r(b).assignedNodes.push(a), c.assignedSlot = b) : c.assignedSlot = void 0;
        d !== c.assignedSlot && c.assignedSlot && (r(c.assignedSlot).ka = !0)
    };
    k.Ta = function(a) {
        var b = u(a),
            c = b.assignedNodes;
    ...
    k.Va = function(a) {
        ...
        for (a = a.__shady_firstChild; a; a = a.__shady_nextSibling)
            if (this.ib(a))
                for (var c = u(a).K, d = 0; d < c.length; d++) b.push(c[d]);
            else b.push(a);
        return b
    };
    k.ib = function(a) {
            ...
            for (c in b)
                for (var d = b[c], e = 0; e < d.length; e++) {
                    ...
                    if (ra(a, f)) {
                        ...
                        0 <= g && (this.g.splice(g, 1), (g = u(f.__shady_parentNode)) && g.T && g.T--);
                        e--;
                        this.sb(f);
                        g = !0
                    }
    ...
    if (window.customElements && window.customElements.define && v.inUse && !v.preferPerformance) {
        var Pc = new Map;
        Nc = function() {
            var a = [];
        ...
        M && document.addEventListener("readystatechange", function() {
            M = !1;
            Nc()
        }, {
            once: !0
        ...
        var Qc = function(a, b, c) {
                ...
                if (b || c) a.prototype.connectedCallback = a.prototype.__shadydom_connectedCallback =
                    function() {
                        M ? Pc.set(this, !0) : this[e] || (this[e] = !0, b && b.call(this))
                    }, a.prototype.disconnectedCallback = a.prototype.__shadydom_disconnectedCallback = function() {
                        M ? this.isConnected || Pc.set(this, !1) : this[e] && (this[e] = !1, c && c.call(this))
                    };
                return a
            },
    ...
    k.append = function() {
        return this.node.__shady_append.apply(this.node, p(q.apply(0, arguments)))
    };
    k.prepend = function() {
        return this.node.__shady_prepend.apply(this.node, p(q.apply(0, arguments)))
    };
    k.replaceChildren = function() {
        return this.node.__shady_replaceChildren.apply(this.node, p(q.apply(0, arguments)))
    };
    k.after = function() {
        return this.node.__shady_after.apply(this.node, p(q.apply(0, arguments)))
    };
    k.before = function() {
        return this.node.__shady_before.apply(this.node, p(q.apply(0, arguments)))
    };
    k.remove = function() {
        return this.node.__shady_remove()
    };
    k.replaceWith = function() {
        return this.node.__shady_replaceWith.apply(this.node, p(q.apply(0, arguments)))
    };
    da.Object.defineProperties(N.prototype, {
        activeElement: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    function Vc(a) {
        if (x(a) || a instanceof N) return a;
        var b = Uc.get(a);
        b || (b = new N(a), Uc.set(a, b));
        return b
    };
    if (v.inUse) {
        var Wc = v.j ? function(a) {
                return a
            } : function(a) {
                eb(a);
                db(a);
            ...
            ShadyDOM = {
                ...
                wrap: v.noPatch ? Vc : Wc,
                wrapIfNeeded: !0 === v.noPatch ? Vc : function(a) {
                    return a
                },
                Wrapper: N,
                composedPath: nb,
        ...
        z(Window.prototype, Dc, "__shady_");
        v.noPatch ? v.ma && z(Element.prototype, rc) : (Fc(), Gb());
        Bb();
        window.Event = Db;
    ...
    */
    ...
    function jd(a) {
        id = a && a.shimcssproperties ? !1 : O || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"))
    }
    var kd;
    window.ShadyCSS && void 0 !== window.ShadyCSS.cssBuild && (kd = window.ShadyCSS.cssBuild);
    var P = !(!window.ShadyCSS || !window.ShadyCSS.disableRuntime);
    ...
    function S(a, b, c, d) {
        if (a) {
            ...
            if ((a = a.rules) && !e)
                for (e = 0, f = a.length, g = void 0; e < f && (g = a[e]); e++) S(g, b, c, d)
        }
    }
    ...
    function Hd(a, b, c, d, e) {
        var f = W;
        e = void 0 === e ? "" : e;
        "" === e && (O || "shady" === (void 0 === d ? "" : d) ? e = R(b, c) : (a = U(a), e = Id(f, b, a.is, a.R, c) + "\n\n"));
        return e.trim()
    }
    ...
    Sd.prototype._getStyleRules = Sd.prototype.hb;
    ...
    var Vd = /:host\s*>\s*/,
        Wd = navigator.userAgent.match("Trident");
    ...
    function ae(a, b, c) {
        b && (b = 0 <= b.indexOf(";") ? be(a, b, c) : yd(b, function(d, e, f, g) {
            if (!e) return d + g;
            (e = ae(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = ae(a, c[f] || f, c) || f;
            return d + (e || "") + g
        }));
        return b && b.trim() || ""
    }
    ...
    function ce(a, b) {
        ...
        S(a, function(e) {
            ...
            b && e.l.B && f && Ud.call(b, f) && ($d(e, c), e = e.index, f = parseInt(e / 32, 10), d[f] = (d[f] || 0) | 1 << e % 32)
        }, null, !0);
        return {
            B: c,
            key: d
    ...
    function de(a, b, c, d) {
        ...
        if (b.l.B) {
            ...
            var g = !!f.match(Vd) || "html" === e && -1 < f.indexOf("html");
            var h = 0 === f.indexOf(":host") && !g;
            "shady" === c && (g = f === e + " > *." + e || -1 !== f.indexOf("html"), h = !g && 0 === f.indexOf(e));
            if (g || h) c = e, h && (b.o || (b.o = W.Da(b, W.ia, W.qa(a), e)), c = b.o || e), g && "html" === e && (c = b.o || b.Yb), d({
                na: c,
                Lb: h,
                Xb: g
            })
    ...
    function ee(a, b, c) {
        ...
        S(b, function(f) {
            de(a, f, c, function(g) {
                Ud.call(a._element || a, g.na) && (g.Lb ? $d(f, d) : $d(f, e))
            })
        }, null, !0);
        return {
            Pb: e,
    ...
    function fe(a, b, c, d) {
        ...
        return Hd(b, e, function(l) {
            var n = "";
            l.l || Zd(l);
            l.l.cssText && (n = be(a, l.l.cssText, c));
            l.cssText = n;
            if (!O && !td(l) && l.cssText) {
                var t = n = l.cssText;
    ...
    Xd.prototype.Xa = function(a, b, c) {
        a = b.jb;
        b = {};
        if (!O && a)
    ...
    function ge(a, b) {
        var c = he,
            d = sd(a);
        a.textContent = R(d, function(e) {
            var f = e.cssText = e.parsedCssText;
            e.l && e.l.cssText && (f = f.replace(ed, "").replace(fd, ""), e.cssText = be(c, f, b))
        })
    }
    ...
    le.prototype.Fb = function(a, b, c) {
    ...
    le.prototype.fetch = function(a, b, c) {
        if (a = this.cache[a])
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        var f = e.getRootNode(),
                            g = oe(e);
                        if (g && f === e.ownerDocument && ("style" !== e.localName && "template" !== e.localName || "" === V(e))) Gd(e, g);
                        else if (f instanceof ShadowRoot)
                            for (f = pe(e), f !== g && Fd(e, g, f), e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.S + ")"), g = 0; g < e.length; g++) {
                                f = e[g];
                                var h = pe(f);
                                h && W.element(f, h)
                            }
    ...
    if (!(O || window.ShadyDOM && window.ShadyDOM.handlesDynamicScoping)) {
        ...
        if (window.customElements && !window.customElements.polyfillWrapFlushCallback) se(document);
        else {
            var te = function() {
                se(document.body)
            };
    ...
    function ye(a) {
        ...
        a._validating || (a._validating = !0, ve.then(function() {
    ...
    k.prepareTemplateStyles = function(a, b, c) {
        if (!a._prepared && !P) {
            ...
            var f = this.bb(a) + (ze[b] || "");
            this.M();
            if (!e) {
                var g;
                if (g = !d) g = md.test(f) || ld.test(f), md.lastIndex = 0, ld.lastIndex = 0;
                var h = Yc(f);
                g && Q && this.m && this.m.transformRules(h, b);
                a._styleAst = h
            }
            g = [];
            Q || (g = Yd(a._styleAst));
            if (!g.length || Q) b = this.eb(c, a._styleAst, O ? a.content : null, ie[b] || null, d, e ? f : ""), a._style = b;
            a.pb = g
        }
    };
    ...
    k.prepareTemplateDom = function(a, b) {
        if (!P) {
            var c = V(a);
            O || "shady" === c || a._domPrepared || (a._domPrepared = !0, Ed(a.content, b))
        }
    };
    ...
    k.Ya = function() {
        return !this.m && window.ShadyCSS && window.ShadyCSS.ApplyShim ? (this.m = window.ShadyCSS.ApplyShim, this.m.invalidCallback = we, !0) : !1
    };
    k.Za = function() {
        var a = this;
    ...
    k.flushCustomStyles = function() {
        if (!P) {
            ...
            if (this.h) {
                ...
                !a && !this.h.enqueued || Cd(this.A.cssBuild) || (Q ? this.A.cssBuild || this.wb(b) : (this.tb(b), this.ja(this.H, this.A), this.Qa(b), this.ea && this.styleDocument()), this.h.enqueued = !1)
            }
        }
    };
    k.tb = function(a) {
    ...
    k.styleElement = function(a, b) {
        if (P) {
            if (b) {
                X(a) || Td(a, new Sd(null));
                var c = X(a);
                this.wa(c, b);
                Be(this, a, c)
            }
        } else if (c = X(a) || this.ya(a)) this.fa(a) || (this.ea = !0), b && this.wa(c, b), Q ? Be(this, a, c) : (this.flush(), this.ja(a, c), c.la && c.la.length && this.Ra(a, c))
    };
    k.wa = function(a, b) {
        a.L = a.L || {};
        Object.assign(a.L, b)
    ...
    function Be(a, b, c) {
        ...
        if (((e = ue[d]) || a.fa(b)) && (!e || "" === V(e)) && e && e._style && !xe(e)) {
            if (xe(e) || e._applyShimValidatingVersion !== e._applyShimNextVersion) a.M(), a.m && a.m.transformRules(e._styleAst, d), e._style.textContent = Hd(b, c.v), ye(e);
            O && (a = b.shadowRoot) && (a = a.querySelector("style")) && (a.textContent = Hd(b, c.v));
            c.v = e._styleAst
        }
    }
    k.ha = function(a) {
    ...
    k.Ra = function(a, b) {
        var c = U(a).is,
            d = Ae.fetch(c, b.C, b.la),
            e = d ? d.styleElement : null,
            f = b.u;
        b.u = d && d.u || this.cb(c);
        var g = b.u;
        var h = he;
        h = e ? e.textContent || "" : fe(h, a, b.C, g);
        var m = X(a),
            l = m.J;
        l && !O && l !== e && (l._useCount--, 0 >= l._useCount && l.parentNode && l.parentNode.removeChild(l));
        O ? m.J ? (m.J.textContent = h, e = m.J) : h && (e = ud(h, g, a.shadowRoot, m.placeholder)) : e ? e.parentNode || (Wd && -1 < h.indexOf("@media") && (e.textContent = h), vd(e, null, m.placeholder)) : h && (e = ud(h, g, null, m.placeholder));
        e && (e._useCount = e._useCount || 0, m.J !=
            e && e._useCount++, m.J = e);
        g = e;
        O || (e = b.u, m = h = a.getAttribute("class") || "", f && (m = h.replace(new RegExp("\\s*x-scope\\s*" + f + "\\s*", "g"), " ")), m += (m ? " " : "") + "x-scope " + e, h !== m && zd(a, m));
        d || Ae.store(c, b.C, g, b.u);
        return g
    };
    k.ja = function(a, b) {
        var c = this.ha(a),
        ...
        e = 0;
        for (var f; e < d.length; e++) f = d[e], c[f] = ae(a, c[f], c);
        b.C = c
    };
    k.mb = function(a, b) {
        for (var c in b) {
    ...
    k.Ja = function(a) {
        ...
        if (!Cd(c)) {
            ...
            S(d, function(e) {
                ...
                Q && "" === c && (b.M(), b.m && b.m.transformRule(e))
            });
            Q ? a.textContent = R(d) : this.A.v.rules.push(d)
        }
    };
    k.vb = function(a) {
        if (Q && this.m) {
    ...
    var Z = new Y,
        Ce, De;
    window.ShadyCSS && (Ce = window.ShadyCSS.ApplyShim, De = window.ShadyCSS.CustomStyleInterface);
    window.ShadyCSS = {
        ScopingShim: Z,
    ...
    Ce && (window.ShadyCSS.ApplyShim = Ce);
    De && (window.ShadyCSS.CustomStyleInterface = De);
})();
